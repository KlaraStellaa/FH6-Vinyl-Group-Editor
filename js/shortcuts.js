App.SHORTCUTS = [
  {
    group: 'sc.g.canvas', items: [
      ...
      { keys: [{ act: 'hideLayers' }], desc: 'sc.d.hideLayers' },
      { keys: [{ act: 'hideOthers' }], desc: 'sc.d.hideOthers' },
      { keys: [{ act: 'hideBg' }], desc: 'sc.d.hideBg' }
    ]
  },
  {
    group: 'sc.g.select', items: [
      ...
      { keys: [{ act: 'highlight' }, 'sc.k.dragCanvas'], desc: 'sc.d.hlBox' },
      { keys: [{ act: 'highlight' }, 'Ctrl', 'sc.k.dragCanvas'], desc: 'sc.d.hlBoxCancel' },
...
App.SC_I18N = {
  'zh-CN': {
    ...
    'sc.k.dbl': '双击', 'sc.k.mouseDbl': '鼠标双击', 'sc.k.dragBar': '拖动图层栏', 'sc.k.dragCanvas': '鼠标画布内拖动',
    ...
    'sc.d.hideLayers': '隐藏图层', 'sc.d.hideOthers': '只显示当前正在编辑的图层', 'sc.d.hideBg': '隐藏背景图片',
  ...
  'zh-TW': {
    ...
    'sc.k.dbl': '雙擊', 'sc.k.mouseDbl': '滑鼠雙擊', 'sc.k.dragBar': '拖曳圖層列', 'sc.k.dragCanvas': '滑鼠畫布內拖曳',
    ...
    'sc.d.hideLayers': '隱藏圖層', 'sc.d.hideOthers': '只顯示目前正在編輯的圖層', 'sc.d.hideBg': '隱藏背景圖片',
  ...
  'en': {
    ...
    'sc.k.dbl': 'double-click', 'sc.k.mouseDbl': 'Mouse double-click', 'sc.k.dragBar': 'Drag in layer bar', 'sc.k.dragCanvas': 'drag on canvas',
    ...
    'sc.d.hideLayers': 'Hide layers', 'sc.d.hideOthers': 'Show only the layer being edited', 'sc.d.hideBg': 'Hide the background image',
  ...
  'ja': {
    ...
    'sc.k.dbl': 'ダブルクリック', 'sc.k.mouseDbl': 'マウスダブルクリック', 'sc.k.dragBar': 'レイヤー列をドラッグ', 'sc.k.dragCanvas': 'キャンバス内ドラッグ',
    ...
    'sc.d.hideLayers': 'レイヤーを隠す', 'sc.d.hideOthers': '編集中のレイヤーだけを表示', 'sc.d.hideBg': '背景画像を隠す',
  ...
  'ko': {
    ...
    'sc.k.dbl': '더블 클릭', 'sc.k.mouseDbl': '마우스 더블 클릭', 'sc.k.dragBar': '레이어 목록 드래그', 'sc.k.dragCanvas': '캔버스 내 드래그',
    ...
    'sc.d.hideLayers': '레이어 숨기기', 'sc.d.hideOthers': '편집 중인 레이어만 표시', 'sc.d.hideBg': '배경 이미지 숨기기',
