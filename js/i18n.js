...
App.i18n = {
  ...
  dicts: {
    'zh-CN': {
      ...
      'settings.theme.midnight': '午夜蓝', 'settings.theme.forest': '松林', 'settings.theme.ember': '暖炭',
      'settings.theme.sepia': '米白', 'settings.theme.frost': '霜蓝', 'settings.theme.sakura': '樱粉',
      'theme.presets': '预设', 'theme.custom': '自定义', 'theme.back': '返回',
      'theme.seed.bg': '底色', 'theme.seed.panel': '面板', 'theme.seed.accent': '强调色', 'theme.seed.text': '正文色',
      'theme.custom.apply': '应用自定义', 'theme.custom.reset': '恢复默认',
      'theme.warn': '对比度不足（{v}），文字可能看不清',
      ...
      'canvas.hideOthers': '隐藏其他图层', 'canvas.showOthers': '显示其他图层',
      'canvas.hideBg': '隐藏背景', 'canvas.showBg': '显示背景',
      'canvas.opLayers': '图层', 'canvas.opBg': '背景',
      'panel.layers': '图层', 'panel.totalPrefix': '图案总数：', 'panel.totalPair': '{in}（{all}）',
      'sel.editPos': '编辑图层', 'sel.editColor': '改变颜色', 'sel.replace': '更换图案',
      ...
      'sel.selectAll': '高亮所有图层', 'sel.clearSel': '取消高亮所有图层', 'sel.locateLayer': '定位图层位置', 'sel.groupEdit': '分组内编辑', 'sel.groupBack': '返回',
    ...
    'zh-TW': {
      ...
      'settings.theme.midnight': '午夜藍', 'settings.theme.forest': '松林', 'settings.theme.ember': '暖炭',
      'settings.theme.sepia': '米白', 'settings.theme.frost': '霜藍', 'settings.theme.sakura': '櫻粉',
      'theme.presets': '預設', 'theme.custom': '自訂', 'theme.back': '返回',
      'theme.seed.bg': '底色', 'theme.seed.panel': '面板', 'theme.seed.accent': '強調色', 'theme.seed.text': '文字色',
      'theme.custom.apply': '套用自訂', 'theme.custom.reset': '恢復預設',
      'theme.warn': '對比度不足（{v}），文字可能看不清',
      ...
      'canvas.hideOthers': '隱藏其他圖層', 'canvas.showOthers': '顯示其他圖層',
      'canvas.hideBg': '隱藏背景', 'canvas.showBg': '顯示背景',
      'canvas.opLayers': '圖層', 'canvas.opBg': '背景',
      'panel.layers': '圖層', 'panel.totalPrefix': '圖案總數：', 'panel.totalPair': '{in}（{all}）',
      'sel.editPos': '編輯圖層', 'sel.editColor': '改變顏色', 'sel.replace': '更換圖案',
      ...
      'sel.selectAll': '反白所有圖層', 'sel.clearSel': '取消反白所有圖層', 'sel.locateLayer': '定位圖層位置', 'sel.groupEdit': '分組內編輯', 'sel.groupBack': '返回',
    ...
    'en': {
      ...
      'settings.theme.midnight': 'Midnight', 'settings.theme.forest': 'Forest', 'settings.theme.ember': 'Ember',
      'settings.theme.sepia': 'Sepia', 'settings.theme.frost': 'Frost', 'settings.theme.sakura': 'Sakura',
      'theme.presets': 'Presets', 'theme.custom': 'Custom', 'theme.back': 'Back',
      'theme.seed.bg': 'Base', 'theme.seed.panel': 'Panel', 'theme.seed.accent': 'Accent', 'theme.seed.text': 'Text',
      'theme.custom.apply': 'Apply custom', 'theme.custom.reset': 'Reset',
      'theme.warn': 'Low contrast ({v}) — text may be hard to read',
      ...
      'canvas.hideOthers': 'Hide other layers', 'canvas.showOthers': 'Show other layers',
      'canvas.hideBg': 'Hide background', 'canvas.showBg': 'Show background',
      'canvas.opLayers': 'Layers', 'canvas.opBg': 'Background',
      'panel.layers': 'Layers', 'panel.totalPrefix': 'Patterns: ', 'panel.totalPair': '{in} ({all})',
      'sel.editPos': 'Edit layer', 'sel.editColor': 'Change color', 'sel.replace': 'Replace shape',
      ...
      'sel.selectAll': 'Highlight all layers', 'sel.clearSel': 'Clear highlight', 'sel.locateLayer': 'Locate layer', 'sel.groupEdit': 'Edit in group', 'sel.groupBack': 'Back',
    ...
    'ja': {
      ...
      'settings.theme.midnight': 'ミッドナイト', 'settings.theme.forest': 'フォレスト', 'settings.theme.ember': 'エンバー',
      'settings.theme.sepia': 'セピア', 'settings.theme.frost': 'フロスト', 'settings.theme.sakura': 'さくら',
      'theme.presets': 'プリセット', 'theme.custom': 'カスタム', 'theme.back': '戻る',
      'theme.seed.bg': 'ベース', 'theme.seed.panel': 'パネル', 'theme.seed.accent': 'アクセント', 'theme.seed.text': '文字色',
      'theme.custom.apply': 'カスタムを適用', 'theme.custom.reset': '初期値に戻す',
      'theme.warn': 'コントラスト不足（{v}）— 文字が読みにくい可能性',
      ...
      'canvas.hideOthers': '他のレイヤーを隠す', 'canvas.showOthers': '他のレイヤーを表示',
      'canvas.hideBg': '背景を隠す', 'canvas.showBg': '背景を表示',
      'canvas.opLayers': 'レイヤー', 'canvas.opBg': '背景',
      'panel.layers': 'レイヤー', 'panel.totalPrefix': '図形の総数：', 'panel.totalPair': '{in}（{all}）',
      'sel.editPos': 'レイヤーを編集', 'sel.editColor': '色を変更', 'sel.replace': '図形を差し替え',
      ...
      'sel.selectAll': 'すべてのレイヤーを強調', 'sel.clearSel': '強調をすべて解除', 'sel.locateLayer': 'レイヤー位置へ移動', 'sel.groupEdit': 'グループ内を編集', 'sel.groupBack': '戻る',
    ...
    'ko': {
      ...
      'settings.theme.midnight': '미드나이트', 'settings.theme.forest': '포레스트', 'settings.theme.ember': '엠버',
      'settings.theme.sepia': '세피아', 'settings.theme.frost': '프로스트', 'settings.theme.sakura': '사쿠라',
      'theme.presets': '프리셋', 'theme.custom': '사용자 지정', 'theme.back': '뒤로',
      'theme.seed.bg': '배경색', 'theme.seed.panel': '패널', 'theme.seed.accent': '강조색', 'theme.seed.text': '본문색',
      'theme.custom.apply': '사용자 지정 적용', 'theme.custom.reset': '기본값 복원',
      'theme.warn': '대비 부족({v}) — 글자가 잘 안 보일 수 있음',
      ...
      'canvas.hideOthers': '다른 레이어 숨기기', 'canvas.showOthers': '다른 레이어 표시',
      'canvas.hideBg': '배경 숨기기', 'canvas.showBg': '배경 표시',
      'canvas.opLayers': '레이어', 'canvas.opBg': '배경',
      'panel.layers': '레이어', 'panel.totalPrefix': '도형 총수: ', 'panel.totalPair': '{in} ({all})',
      'sel.editPos': '레이어 편집', 'sel.editColor': '색 변경', 'sel.replace': '도형 교체',
      ...
      'sel.selectAll': '모든 레이어 강조', 'sel.clearSel': '강조 모두 해제', 'sel.locateLayer': '레이어 위치로 이동', 'sel.groupEdit': '그룹 내 편집', 'sel.groupBack': '뒤로',
